...
{
    [MenuItem("DD Setup/🎨 Scene Setup/Background/創建可點擊背景")]
    ...
    [MenuItem("DD Setup/🎨 Scene Setup/Background/設定背景為詛咒色調")]
    ...
    [MenuItem("DD Setup/🎨 Scene Setup/Background/設定背景為彩色模式")]
    ...
    [MenuItem("DD Setup/🎨 Scene Setup/Background/開啟/關閉隨機模式")]
    ...
    [MenuItem("DD Setup/🎨 Scene Setup/Background/調整背景大小適應畫面")]
    ...
    [MenuItem("DD Setup/🎨 Scene Setup/Background/重置背景為黑色")]
